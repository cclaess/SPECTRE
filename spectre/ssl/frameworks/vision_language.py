...
#     vision_encoder = vit_tiny_patch16_128(num_classes=0)
#     vision_feature_comb = FeatureVisionTransformer(patch_dim=vision_encoder.embed_dim, num_patches=2)
#     model_config = Qwen2Config.from_pretrained(
#         "infgrad/jasper_en_vision_language_v1", 
#         cache_dir=Path(__file__).parent.parent.parent.as_posix() / "temp"
#     )
    # print(model_config)
