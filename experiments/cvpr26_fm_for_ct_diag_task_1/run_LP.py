...
def get_args():
    ...
    parser.add_argument("--embeds_root", default='/path/to/embeddings', 
                        help="Root directory containing subdirectories of embeddings for each target")
    parser.add_argument("--labels_root", type=str,
                        default='/path/to/labels',
                        help='Root directory containing CSV files for labels')
    parser.add_argument("--target", type=str, default='splenomegaly',
                        help='target name (used to construct CSV filename: target.csv)')
    parser.add_argument("--out_dir", type=str, default=None, 
                        help="Directory to save results (default: embeds_root/target/linear_probe_results)")
    ...
    parser.add_argument("--monitor_metric", type=str, default="balanced_acc")
    parser.add_argument("--monitor_metric_mode", type=str, default='max')
    parser.add_argument("--top_k_checkpoints", type=int, default=3)
    parser.add_argument("--log_interval", type=int, default=10)
    parser.add_argument("--use_wandb", action="store_true", 
                        help="Enable Weights & Biases logging")
    parser.add_argument("--wandb_project", type=str, default="linear_probe_cvpr26")
